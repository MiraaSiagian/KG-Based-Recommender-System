...
class Dataloader:
    ...
    def _convert_kg(self, lines):
        ...
        relation_file_path = os.path.join(os.path.dirname(__file__), '..', 'data', 'relation2id.txt')
        
        for line in open(relation_file_path,
...
class KGRS:
    def __init__(self, train_pos: np.array, train_neg: np.array,
        kg_lines: List[str], n_user: int, n_item: int, config: dict):
        """
        Initialize the Algorithm
        :param train_pos: The Positive Samples in the Training Set...
        :param train_neg: The Negative Samples in the Training Set...
        :param kg_lines: The Knowledge Graph Lines...
        """
    ...
    def eval_ctr(self, test_data: np.array) -> np.array:
        ...
        :param test_data: The test data that you need to predict...
        :return: The prediction result...
        """
        eval_batches = np.array_split(test_data, max(1, len(test_data) //
    ...
    def eval_topk(self, users: List[int], k: int = 5) -> \
        ...
        :param users: The list of the id of the users...
        :param k: The number of the items recommended...
        :return: The items recommended...
        """
